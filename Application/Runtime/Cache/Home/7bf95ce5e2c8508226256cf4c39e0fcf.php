...
<header>
    <div class="container">
        <div class="headertop" style="overflow: hidden;">
            <!-- blog网站名称 -->
            <h1><a href="/" style="text-decoration: none;">NO.5</a></h1>
        </div>
    </div>
</header>
<div class="container" style="margin-top: 30px;">
    <div style="min-height: 500px;">
        <div  class="col-sm-5" style="">
            <img src="/Public/images/aa.jpg" alt="图片logo" style="width: 100%;height: 400px;">
        </div>
        <div class="col-sm-6 " id="qiehuan">
            ...
            <div class="tab-content">
                <div style="margin-top: 10px;">
                    <a href="<?php echo U('User/index');?>">返回首页&gt;&gt;&gt;</a>
                </div>
                <div class="tab-pane active" id="Userlogin" style="padding: 10px 0 0 20px;">
                    <form action="<?php echo U('User/Userlogin_yanzheng');?>" method="post" onsubmit="return Userchk(this)">
                        ...
                        <p>
                            验证码:<input type="text" id="yzm" name="yzm" style="width:60%;margin-top: 10px;" class="input-lg" placeholder="请输入验证码">
                        </p>
                        <p>
                            <!--<input type="text" name="yzm" style="width: 85%;" class="input-lg" placeholder="请输入验证码">-->
                            <img src="<?php echo U('BTP/yanzhengma');?>" alt="验证码图片" onclick="changeimg(this)">
                        </p>
                        <!--<p>-->
...
//    function User(){
//        document.getElementById('Userlujing').src="<?php echo U('yanzhengma');?>";
//    }
    function changeimg(img){
        img.src = "<?php echo U('BTP/yanzhengma');?>?"+new Date().getTime();
    }
 function Admin(){
        document.getElementById('Adminlujing').src="<?php echo U('yanzhengma');?>";
    }
</script>
